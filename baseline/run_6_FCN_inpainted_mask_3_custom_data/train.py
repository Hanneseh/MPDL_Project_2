...
# Parameters
checkpoint_dir = "run_6_FCN_inpainted_mask_3_custom_data/checkpoints"
docs_path = "run_6_FCN_inpainted_mask_3_custom_data/docs"
num_epochs = 100
batch_size = 8
...
# datasets
data_dir = "custom_data_2" # expects contained directories: train, test, val
train_dataset = InpaintedDataset(os.path.join(data_dir, 'train'))
test_dataset = InpaintedDataset(os.path.join(data_dir, 'test'))
val_dataset = InpaintedDataset(os.path.join(data_dir, 'val'))
