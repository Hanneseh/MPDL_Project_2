...
from dataset import fakefakeDataset
import os
...
# Parameters
checkpoint_dir = "run_7_FCN_fakefake_maks_3_custom_data/checkpoints"
docs_path = "run_7_FCN_fakefake_maks_3_custom_data/docs"
num_epochs = 100
batch_size = 8
...
# datasets
data_dir = "data/custom_data" # expects contained directories: train, test, val
train_dataset = fakefakeDataset(os.path.join(data_dir, 'train'))
test_dataset = fakefakeDataset(os.path.join(data_dir, 'test'))
val_dataset = fakefakeDataset(os.path.join(data_dir, 'val'))

# # for dev purposes: reduce the number of images in the datasets to only 10
# train_dataset = Subset(train_dataset, range(15))
