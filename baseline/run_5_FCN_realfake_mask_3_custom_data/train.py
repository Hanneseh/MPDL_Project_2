...
# Parameters
checkpoint_dir = "run_5_FCN_realfake_mask_3_custom_data/checkpoints"
docs_path = "run_5_FCN_realfake_mask_3_custom_data/docs"
num_epochs = 100
batch_size = 8
...
# datasets
data_dir = "custom_data" # expects contained directories: train, test, val
