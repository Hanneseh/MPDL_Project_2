...
if __name__== "__main__":
    ...
    PATH_SAVE = "nix_60_dataset2_fakefake.pth"
    ...
    train_data = CombinedDataset(PATH_TRAIN1, PATH_TRAIN2, "fakefake")
    val_data = CombinedDataset(PATH_VAL1, PATH_VAL2, "fakefake")
    ...
    test_data = CombinedDataset(PATH_TEST1, PATH_TEST2, "fakefake")
