...
class NIX(nn.Module):
    def __init__(self, img_width, img_height):
        ...
        self.conv_4 = ConvBlock(1792, 1)

        self.upsample_1 = Upsample([self.img_width_2, self.img_height_2], 512, 512)
        self.upsample_2 = nn.Sequential(Upsample([self.img_width_3, self.img_height_3], 1024, 1024), 
                                        Upsample([self.img_width_2, self.img_height_2], 1024, 1024)) 
