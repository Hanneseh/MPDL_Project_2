...
if __name__== "__main__":
    ...
    PATH_SAVE = "nix_40_dataset1_fakefake.pth"
    ...
    train_data = ImageDataset(PATH_TRAIN, "fakefake")
    val_data = ImageDataset(PATH_VAL, "fakefake")
    ...
    test_data = ImageDataset(PATH_TEST, "fakefake")
